...
const CheckoutSteps = ({ shipping, confirmOrder, payment }) => {
    ...
    return (
        ...
        {shipping ? <Link to='/shipping' className="float-right">
            ...
            <div className="step active-step">Endereço</div>
            <div className="triangle-active"></div>
        </Link> : 
            <Link to="#!" disabled>
                <div className="triangle2-incomplete"></div>
                <div className="step incomplete">Endereço</div>
        ...
        {payment ? <Link to='/payment' className="float-right">
            <div className="triangle2-active"></div>
            <div className="step active-step">Pagamento</div>
            <div className="triangle-active"></div>
        </Link> : 
            <Link to="#!" disabled>
                <div className="triangle2-incomplete"></div>
                <div className="step incomplete">Pagamento</div>
                <div className="triangle-incomplete"></div>
            </Link>}
